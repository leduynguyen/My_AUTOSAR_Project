...
#define SG_OS_STD_END_3(_service_id,_p1,_p2,_p3) \
        goto ok;        \
    err:                \
       ERRORHOOK(rv);  \
    ok:                 \
...
StatusType SetAbsAlarm(AlarmType AlarmId, TickType Start, TickType Cycle) {
    ...
    if( currPcbPtr->constPtr->applOwnerId != aPtr->applOwnerId ) {
        ...
        SG_OS_STD_END_3(OSServiceId_SetAbsAlarm,AlarmId, Start, Cycle);
}
...
StatusType SetRelAlarm(AlarmType AlarmId, TickType Increment, TickType Cycle){
    ...
    if( currPcbPtr->constPtr->applOwnerId != aPtr->applOwnerId ) {
        ...
        SG_OS_STD_END_3(OSServiceId_SetRelAlarm,AlarmId, Increment, Cycle);
}
