...
/*lint -esym(9003, crc32_tab) MISRA Exception: Readability (MISRA 2012 Rule 8.9, advisory) */
#if CRC_32_MODE == CRC_32_TABLE
static const uint32 crc32_tab[] = { 0x00000000U,0x77073096U,0xEE0E612CU,0x990951BAU,0x076DC419U,0x706AF48FU,0xE963A535U,0x9E6495A3U,
...
uint32 Crc_CalculateCRC32( const uint8* Crc_DataPtr, uint32 Crc_Length, uint32 Crc_StartValue32, boolean Crc_IsFirstCall ) {
    ...
    if (Crc_DataPtr != NULL) {
        ...
        crc = (TRUE == Crc_IsFirstCall) ? CRC32_START_VALUE : (Crc_StartValue32 ^ CRC32_XOR);
