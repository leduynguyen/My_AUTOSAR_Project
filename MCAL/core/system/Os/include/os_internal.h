...
/*lint -emacro(923, OS_STD_END_1)
 * MISRA 2004 11.1 (req), 2004 11.3 (adv), 2012 11.1 (req), 2012 11.4 (adv), 2012 11.6 (req)
 * Allow any pointer type to integer type conversion used for error handling in this macro
 */
 ...
 */
/** @req OS246  @req OS540  Application error hook to be called after system error hook */
#define ERRORHOOK(x) \
