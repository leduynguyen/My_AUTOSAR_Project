...
vpath-$(CFG_ZYNQ)-$(USE_FLS) += $(ROOTDIR)/$(ARCH_PATH-y)/drivers/qspips_v3_1/src
inc-$(CFG_ZYNQ)-$(USE_FLS) += $(ROOTDIR)/$(ARCH_PATH-y)/drivers/qspips_v3_1/src
vpath-$(CFG_ZYNQ)-$(USE_FLS) += $(ROOTDIR)/$(ARCH_PATH-y)/drivers/qspips_v3_1/QspiIf
inc-$(CFG_ZYNQ)-$(USE_FLS) += $(ROOTDIR)/$(ARCH_PATH-y)/drivers/qspips_v3_1/QspiIf
inc-$(CFG_ZYNQ)-$(USE_FLS) += $(ROOTDIR)/$(ARCH_PATH-y)/drivers/qspips_v3_1
