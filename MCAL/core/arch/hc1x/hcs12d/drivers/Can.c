...
#define GET_CALLBACKS() \
                            (Can_Global.config->CanConfigSetPtr->CanCallbacks)
...
static const Can_HardwareObjectType * Can_FindHoh( Can_HwHandleType hth , uint32* controller)
{
  ...
  {
    DET_REPORTERROR(CAN_MODULE_ID, 0, 0x6, CAN_E_PARAM_HANDLE);
  }
...
ISR(Can_0_RxIsr) {	Can_RxIsr(CAN_CTRL_0); }
ISR(Can_1_RxIsr) {	Can_RxIsr(CAN_CTRL_1); }
ISR(Can_2_RxIsr) {	Can_RxIsr(CAN_CTRL_2); }
ISR(Can_3_RxIsr) {	Can_RxIsr(CAN_CTRL_3); }
ISR(Can_4_RxIsr) {	Can_RxIsr(CAN_CTRL_4); }

ISR(Can_0_TxIsr) {	Can_TxIsr(CAN_CTRL_0); }
ISR(Can_1_TxIsr) {	Can_TxIsr(CAN_CTRL_1); }
ISR(Can_2_TxIsr) {	Can_TxIsr(CAN_CTRL_2); }
ISR(Can_3_TxIsr) {	Can_TxIsr(CAN_CTRL_3); }
ISR(Can_4_TxIsr) {	Can_TxIsr(CAN_CTRL_4); }

ISR(Can_0_ErrIsr) {	Can_ErrIsr(CAN_CTRL_0); }
ISR(Can_1_ErrIsr) {	Can_ErrIsr(CAN_CTRL_1); }
ISR(Can_2_ErrIsr) {	Can_ErrIsr(CAN_CTRL_2); }
ISR(Can_3_ErrIsr) {	Can_ErrIsr(CAN_CTRL_3); }
ISR(Can_4_ErrIsr) {	Can_ErrIsr(CAN_CTRL_4); }

ISR(Can_0_WakeIsr) {	Can_WakeIsr(CAN_CTRL_0); }
ISR(Can_1_WakeIsr) {	Can_WakeIsr(CAN_CTRL_1); }
ISR(Can_2_WakeIsr) {	Can_WakeIsr(CAN_CTRL_2); }
ISR(Can_3_WakeIsr) {	Can_WakeIsr(CAN_CTRL_3); }
ISR(Can_4_WakeIsr) {	Can_WakeIsr(CAN_CTRL_4); }
