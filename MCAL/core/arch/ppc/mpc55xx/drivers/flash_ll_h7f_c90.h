...
#include "Std_Types.h"
#include <stdbool.h> /*lint !e451 FALSE_POSITIVE */
#include <stdint.h>  /*lint !e451 FALSE_POSITIVE */
#include "flash.h"

/*lint -save -w2 Freescale code */
...
/* NULL callback */
#define NULL_CALLBACK             ((void *) 0xFFFFFFFFuL)
...
#define EE_ARC_ERROR_PARAMETER       0xFFFFFFFFUL
