...
/*lint -save -e754 Local structure member not referenced */
    ...
    CC_EXTENSION struct DSPI_tag {
        ...
        union {
            ...
            struct {
                ...
                vuint32_t EOQ:1;
                vuint32_t CTCNT:1;
#if defined(CFG_MPC5516) || defined(CFG_MPC5517) || defined(CFG_MPC5567) || defined(CFG_MPC563XM) || defined(CFG_MPC5644A)
                vuint32_t:4;
                  vuint32_t PCS5:1;
                vuint32_t PCS4:1;
                vuint32_t PCS3:1;
...
#error CPU run with this header file
...
#if defined(CFG_MPC5516) || defined(CFG_MPC5517) || defined(CFG_MPC5567) || defined(CFG_MPC5644A)
        ...
        union {
                   ...
                   struct {
                       ...
                       vuint32_t MTOCNT:6;
                       vuint32_t:3;
                       vuint32_t TSBC:1; // Available in MPC563XM, MPC5644A
                       vuint32_t TXSS:1;
                       vuint32_t TPOL:1;
                       vuint32_t TRRE:1;
                       vuint32_t CID:1;
                       ...
                       vuint32_t DSICTAS:3;
                       vuint32_t:4;
                       vuint32_t DPCS7:1; // Available in MPC563XM, MPC5644A
                       vuint32_t DPCS6:1; // Available in MPC563XM, MPC5644A
                       vuint32_t DPCS5:1;
                       vuint32_t DPCS4:1;
                       vuint32_t DPCS3:1;
                       vuint32_t DPCS2:1;
