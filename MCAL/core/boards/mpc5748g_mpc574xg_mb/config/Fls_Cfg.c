...
const FlashType flashInfo[] = {
    ...
    [0].addrSpace[0] = ADDR_SPACE_SET(ADDR_SPACE_MID) + 2,
    [0].sectAddr[1] = 0x00620000,
    [0].addrSpace[1] = ADDR_SPACE_SET(ADDR_SPACE_MID) + 3,
    [0].sectAddr[2] = 0x00630000, /* end first chunk */
    [0].addrSpace[2] = SECTOR_EMPTY,

    /* HSM Data */
    [0].sectAddr[3] = 0x00F80000,
    [0].addrSpace[3] = ADDR_SPACE_SET(ADDR_SPACE_LOW) + 0,
    [0].sectAddr[4] = 0x00F84000,
    [0].addrSpace[4] = ADDR_SPACE_SET(ADDR_SPACE_LOW) + 1,
    ...
    [0].addrSpace[21] = ADDR_SPACE_SET(ADDR_SPACE_HIGH) + 0,
    [0].sectAddr[22] = 0x00FF0000,                                  /* partition 1 */
    [0].addrSpace[22] = ADDR_SPACE_SET(ADDR_SPACE_HIGH) + 1,
