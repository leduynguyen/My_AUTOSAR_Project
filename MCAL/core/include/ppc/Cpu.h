...
#define isync() /*lint -save -e586 -restore */ asm volatile(" se_isync");
#define msync() /*lint -save -e586 -restore */ asm volatile(" se_isync");
#else
...
#endif
#define sync() /*lint -save -e586 -restore */ asm volatile(" sync");

#define Irq_Disable() /*lint -save -e586 -restore */ asm volatile (" wrteei 0");
#define Irq_Enable()  /*lint -save -e586 -restore */ asm volatile (" wrteei 1");
#define tlbwe()  /*lint -save -e586 -restore */ asm volatile (" tlbwe");
